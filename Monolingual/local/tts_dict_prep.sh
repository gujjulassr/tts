...
echo c_pau >> $dir/silence_phones.txt
echo p_pau >> $dir/silence_phones.txt
echo q_pau >> $dir/silence_phones.txt
echo pau >> $dir/silence_phones.txt
echo pau > $dir/optional_silence.txt
...
python3 local/prepare_lexicon.py tmp/words.txt $dir/lexicon.txt $lang $gender
sed -i '/^[[:space:]]*$/d'  $dir/lexicon.txt
