...
if $use_graphs; then
  ...
  $cmd JOB=1:$nj $dir/log/align.JOB.log \
    ...
    gmm-align-compiled $scale_opts --beam=$beam --retry-beam=$retry_beam --write-per-frame-acoustic-loglikes="ark:$dir/per_frame_logprobs.JOB.ark" --careful=$careful "$mdl" ark:- \
